...
# LOAD DATA
df = conll2pandas("processed_data/v18_80_0_512/test.conll")

with open("test_v18/predictions.txt", "r") as f:
    predict_data = f.readlines()

predict_data = [data.split() for data in predict_data]

df["predicted_tags"] = predict_data

# COMPARE TAGS WITH PREDICT_TAGS
generate_latex_df(df, top_k=50, fname="testv18")
print("Done!")
